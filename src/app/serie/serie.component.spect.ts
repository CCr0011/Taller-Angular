...
describe('SerieListComponent', () => {
  ...
  beforeEach(() => {
    ...
    component.series = [
      new Serie(faker.number.int(),faker.lorem.word(),
        faker.company.name(),faker.number.int(),faker.lorem.paragraph(),
  ...
  it('should have an dd element ', () => {
    ...
    expect(component.series[0].name).toBeInstanceOf(String);
  });
});